...
public class FilterByAge {
    ...
    public static void main(String[] args) {
        ...
        String format = scanner.nextLine();
            people =condition.equals("older")?filterPeople(people, p->p.age>=ageCondition)
    ...
    public static String formatPeople(Collection<Person> people,Function<Person,
                                        String> formatter, String delimiter){
        return people.stream().map(e->formatter.apply(e)).collect(Collectors.joining(delimiter));
