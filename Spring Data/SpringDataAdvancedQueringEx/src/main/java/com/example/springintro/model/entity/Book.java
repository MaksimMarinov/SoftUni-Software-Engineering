...
@Entity
@NamedStoredProcedureQuery(name = "MyProcedure",
        procedureName = "total_amount_of_books_by_author", parameters = {
        ...
        @StoredProcedureParameter(mode = ParameterMode.OUT, name = "count_books", type = Integer.class)})
@Table(name = "books")
